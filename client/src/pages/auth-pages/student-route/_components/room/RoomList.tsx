...
const RoomList = ({ data: room, isLoading, error }: any) => {
  ...
  return (
    <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 xl:gap-14 text-slate-600 mt-10 max-w-7xl mx-auto">
