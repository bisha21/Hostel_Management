        ...
        <div>
            ...
            <p className="text-center font-medium text-base">Select your role</p>
                <div className="flex justify-center items-center gap-4 mt-4">
                    <Card className={cn("bg-transparent p-2 cursor-pointer",role==="student" && "border-2 border-primary")} onClick={() => form.setValue("user_type", "student")}>
                    ...
                    <Card className={cn("bg-transparent p-2 cursor-pointer",role==="admin" && "border-2 border-primary")}>
                        <img src={ADMIN} alt="ADMIN" width={100} onClick={() => form.setValue("user_type", "admin")} />
