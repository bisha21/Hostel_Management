...
import { changePasswordSchema, TChangePasswordSchema } from "../../../schemas/register";
...
export default function ChangePasswordForm() {
    ...
    return (
        <div className="w-full p-4 border rounded-md z-40 bg-card-background">
            ...
            <p className="text-center font-medium text-xs">We got you but remember your password next time.</p>
            <Form {...form}>
